...
from Agent.tinyRAG.component.embedding import Zhipuembedding, OpenAIembedding, HFembedding, Jinaembedding
from Agent.tinyRAG.component.data_chunker import ReadFile
from Agent.tinyRAG.component.databases import Vectordatabase
import os
import json
...
class Openai_model:
    ...
    def chat(self, question: str):
        ...
        prompt = PromptTemplate(template=template, input_variables=["question", "info"]).format(question=question,
                                                                                                info=info)
